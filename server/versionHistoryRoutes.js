...
function registerVersionHistoryRoutes(app, versionHistoryRepository) {
    app.get("/api/version-history", async (request, response) => {
        try {
            response.json({
    ...
    app.post("/api/version-history", async (request, response) => {
    ...
    app.put("/api/version-history/:id", async (request, response) => {
    ...
    app.delete("/api/version-history/:id", async (request, response) => {
        const id = cleanText(request.params.id, 120);
