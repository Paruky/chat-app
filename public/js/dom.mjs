...
export const elements = {
    ...
    newMessagePanel: byId("new-message-panel"),
    newMessageList: byId("new-message-list"),
    newMessageClearButton: byId("new-message-clear-btn"),
    roomList: byId("room-list"),
    roomManagementPanel: byId("room-management-panel"),
    roomManagementTitle: byId("room-management-title"),
    roomManagementCloseButton: byId("room-management-close-btn"),
    roomRenameForm: byId("room-rename-form"),
    roomRenameInput: byId("room-rename-input"),
    roomMemberForm: byId("room-member-form"),
    roomMemberInput: byId("room-member-input"),
    roomMemberList: byId("room-member-list"),
    roomDeleteButton: byId("room-delete-btn"),
    dmList: byId("dm-list"),
    ...
    fileUploadButton: byId("file-upload-btn"),
    photoInput: byId("photo-input"),
    fileInput: byId("file-input"),
    cannedButton: byId("canned-btn"),
    cannedMenu: byId("canned-menu"),
    cannedCloseButton: byId("canned-close-btn"),
    cannedForm: byId("canned-form"),
    cannedInput: byId("canned-input"),
    cannedAddButton: byId("canned-add-btn"),
    cannedPresetList: byId("canned-preset-list"),
    cannedCustomList: byId("canned-custom-list"),
    input: byId("input"),
